...
#define __PACKED_STRUCT         struct __attribute((packed, aligned(1)))
#endif

typedef __PACKED_STRUCT _USB_SETUP_REQ {
    UINT8 bRequestType;
    UINT8 bRequest;
    UINT16 wValue;
    UINT16 wIndex;
...
typedef __PACKED_STRUCT _USB_DEVICE_DESCR {
    UINT8 bLength;
...
typedef __PACKED_STRUCT _USB_CONFIG_DESCR {
    UINT8 bLength;
    UINT8 bDescriptorType;
    UINT16 wTotalLength;
...
typedef __PACKED_STRUCT _USB_INTERF_DESCR {
    UINT8 bLength;
    UINT8 bDescriptorType;
...
typedef __PACKED_STRUCT _USB_ENDPOINT_DESCR {
    UINT8 bLength;
    UINT8 bDescriptorType;
...
typedef __PACKED_STRUCT _USB_CONFIG_DESCR_LONG {
...
typedef __PACKED_STRUCT _USB_HUB_DESCR {
    UINT8 bDescLength;
    UINT8 bDescriptorType;
    UINT8 bNbrPorts;
...
typedef __PACKED_STRUCT _USB_HID_DESCR {
    UINT8 bLength;
    UINT8 bDescriptorType;
    UINT16 bcdHID;
    UINT8 bCountryCode;
...
typedef __PACKED_STRUCT _UDISK_BOC_CBW { /* command of BulkOnly USB-FlashDisk */
    UINT32 mCBW_Sig;
    UINT32 mCBW_Tag;
...
typedef __PACKED_STRUCT _UDISK_BOC_CSW { /* status of BulkOnly USB-FlashDisk */
    UINT32 mCSW_Sig;
    UINT32 mCSW_Tag;
